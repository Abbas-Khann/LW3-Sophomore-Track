...
import { getEtherBalance, getCDTokensBalance, getKLPTokensBalance, getReserveOfCDTokens } from '../utils/getAmounts';
...
const DEX = (): JSX.Element => {
  ...
  const getAmounts = async () => {
    try {
      ...
      const _lpBalance = await getKLPTokensBalance(provider, address);
  ...
  const getProviderOrSigner = async (needSigner :boolean = false) => {
    ...
    if (chainId !== 80001) {
      toast.warning("Change the network to Mumbai");
  ...
  */
  const renderButton = () => {
    ...
    if (!walletConnected) {
      return (
        <button onClick={connectWallet} className="border-2 transition duration-300 ease-out hover:ease-in hover:bg-purple-800 text-3xl rounded px-3 py-2 hover:text-white mb-3">
          Connect Wallet
        </button>
      );
    }
    ...
    if (loading) {
      return <button className="border-2 transition duration-300 ease-out motion-safe:animate-spin hover:ease-in hover:bg-purple-800 text-3xl rounded px-3 py-2 hover:text-white mb-3">Loading...</button>;
    }
        ...
        <div>
          ...
          <div>
            ...
            {utils.parseEther(reservedCD.toString()).eq(zero) ? (
              <div>
                ...
                <input
                  ...
                  className="text-2xl w-44 rounded text-center"
                />
                <button className="bg-blue-400 rounded p-1 text-white" onClick={_addLiquidity}>
                  Add
                </button>
              </div>
            ) : (
              <div>
                ...
                <button className="bg-cyan-400 rounded p-1 text-white" onClick={_addLiquidity}>
                  Add
                </button>
              </div>
            )}
            <div>
              ...
              <button className="bg-red-300 rounded p-1" onClick={_removeLiquidity}>
                Remove
              </button>
            </div>
          </div>
      ...
      return (
        <div>
          ...
          >
            ...
            <option value="cryptoDevToken">KhaNFT Token</option>
          </select>
          <br />
          <div className="">
            {/* Convert the BigNumber to string using the formatEther function from ethers.js */}
          ...
          <button className="bg-blue-400 rounded p-1" onClick={_swapTokens}>
            Swap
          </button>
        </div>
      );
  ...
  return (
    ...
    <main className="h-screen bg-cover bg-[url('/img/ethereum.jpeg')]">
      ...
      <div className="flex flex-col items-center justify-center h-screen text-2xl text-black">
        <div>
          <h1 className="text-4xl text-white">Welcome to Khan Exchange!</h1>
          <div className="">
            Exchange Ethereum &#60;&#62; Khan Tokens
          </div>
          <div>
            <button
              className="bg-blue-400 rounded p-1 mr-2 text-white"
              onClick={() => {
            ...
            <button
              className="bg-blue-400 rounded p-1 text-white"
              onClick={() => {
